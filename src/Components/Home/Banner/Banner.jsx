...
const Banner = () => {
    return (
        <section className="pt-[50px] md:py-0 bg-[#fff]">
            <div className=" md:h-[80vh] banner-inner container mx-auto md:flex md:flex-row md:items-center  md:justify-between gap-5 text-center md:text-left bg-gray-200 md:px-10 py-8 rounded-xl ">
                ...
                <div className="right-content md:w-2/5 flex md:justify-end justify-center">
